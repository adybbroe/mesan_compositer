...
class TestFindCtScenes:
    ...
    def setup_method(self, fake_yamlconfig_file):
    ...
    def test_get_geo_ctype_scenes(self, caplog, fake_empty_nwcsaf_geo_files):
        ...
        expected = ['filename={filepath}/S_NWC_CT_MSG4_MSG-N-VISIR_20230116T104500Z_PLAX.nc'.format(filepath=path),
                    'platform_name=Meteosat-11',
                    'areaid=MSG-N',
                    'timeslot=2023-01-16 10:45:00']
    ...
    @pytest.mark.parametrize("time_of_analysis, minutes, expected",
                             [(datetime(2023, 1, 16, 11, 0), 35, ['2023-01-16 10:30:00',
                                                                  '2023-01-16 10:45:00',
                                                                  '2023-01-16 11:00:00',
                                                                  '2023-01-16 11:15:00',
                                                                  '2023-01-16 11:30:00']),
                              ...
                              (datetime(2023, 1, 16, 11, 0), 25, ['2023-01-16 10:45:00',
                                                                  '2023-01-16 11:00:00',
                                                                  '2023-01-16 11:15:00'])
                              ]
                             )
