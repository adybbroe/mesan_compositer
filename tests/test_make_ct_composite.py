...
def fake_pps_filenames(tmp_path):
    ...
    filenames = []
    for i in range(11):
        filenames.append(tmp_path / "pps{index}.nc".format(index=i+1))
...
class TestctCompositor:
    ...
    def setup_method(self):
        """Set up the tests."""
        import tempfile
        filename = tempfile.NamedTemporaryFile(suffix="my_pps_testfile.nc").name
        geofilename = tempfile.NamedTemporaryFile(suffix="my_pps_geo_testfile.nc").name
        ...
        filename = tempfile.NamedTemporaryFile(suffix="my_msg_testfile.nc").name
        ...
        filename = tempfile.NamedTemporaryFile(suffix="my_msg_testfile.nc")
        platform_name = "Meteosat-11"
